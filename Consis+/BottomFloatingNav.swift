...
public struct BottomFloatingNav: View {
    ...
    public init(selectedTab: Binding<Int>, isPlusMenuOpen: Binding<Bool>) {
    ...
    public var body: some View {
        HStack(spacing: 0) {
            ...
            // Center PLUS button with rotation animation
            Button(action: {
        ...
        .padding(.vertical, 12)
        .background(Theme.Colors.surfaceContainerLowest.opacity(0.9))
...
#Preview {
    BottomFloatingNav(selectedTab: .constant(0), isPlusMenuOpen: .constant(false))
